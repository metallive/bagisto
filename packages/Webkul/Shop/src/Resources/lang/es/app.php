...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                ...
                'cart'              => 'Carrito',
                'compare'           => 'Comparar',
                'dropdown-text'     => 'Gestionar carrito de compras, pedidos y lista de deseos',
            ...
            'footer' => [
                ...
                'locale'                 => 'locale',
                'newsletter-text'        => 'Noticias',
                'order-return'           => 'Devoluciones',
                'payment-policy'         => 'Politicas de pago',
                'privacy-cookies-policy' => 'Privacy cookies policy',
                'shipping-policy'        => 'Politicas de envio',
                'subscribe'              => 'Suscribirse',
                'subscribe-newsletter'   => 'suscribirse a noticias',
                'subscribe-stay-touch'   => 'suscribirse y mantenerse en contacto',
        ...
        'datagrid' => [
            'toolbar' => [
                'mass-actions' => [
                    ...
                    'select-option' => 'Seleccione la opcion',
                    'submit'        => 'ingresar',
                ],
            ...
            'filters' => [
                ...
                'date-options' => [
                    ...
                    'last-six-months'   => 'Ultimo 6 meses',
                    'last-three-months' => 'Ultimo 3 meses',
                    'this-month'        => 'Este mes',
    ...
    'home' => [
        'index' => [
            'offer'               => 'Obtenga HASTA 40% de descuento en su primer pedido COMPRAR AHORA',
            'resend-verify-email' => 'Reenviar correo electrónico de confirmación',
    ...
    'errors' => [
        ...
        '404' => [
            'description' => '¡Ups! El sitio que buscas se encuentra actualmente de vacaciones. Parece que no pudimos encontrar lo que estabas buscando.',
            'title'       => '404 Pagina no encontrada',
        ],

        '401' => [
            'description' => '¡Ups! Parece que no tienes permiso para acceder a esta página. Parece que le faltan los datos de inicio de sesión necesarios.',
            'title'       => '401 No autorizado',
        ],

        '403' => [
            'description' => '¡Ups! Este sitio es tabú. Parece que no tienes los permisos necesarios para ver este contenido.',
            'title'       => '403 Prohibido',
        ],

        '500' => [
            'description' => '¡Ups! Algo salió mal. Parece que tenemos dificultades para cargar la página que estás buscando.',
            'title'       => 'Error interno de servidor 500',
        ],

        '503' => [
            'description' => '¡Ups! Parece que estamos temporalmente desconectados por mantenimiento. Por favor regresa más tarde.',
    ...
    'emails' => [
        ...
        'thanks' => 'Si necesita ayuda, por favor contáctenos en <a href=":link" style=":style">:email</a>.<br/>¡Gracias!',
        ...
        'customers' => [
            ...
            'subscribed' => [
                ...
                'unsubscribe' => 'Cerrar sesión',
            ],
        ],

        'orders' => [
            'created' => [
                'greeting' => 'Gracias por su orden :order_id, efectuado en :created_at',
            ...
            'invoiced' => [
                'greeting' => 'Su cuenta #:invoice_id para ordenar :order_id, creado en :created_at',
            ...
            'shipped' => [
                'greeting' => 'Su pedido :order_id, efectuado en :created_at, ha sido enviado',
            ...
            'refunded' => [
                'greeting' => 'El reembolso se realizó por pedido. :order_id, efectuado en :created_at, iniciado',
            ...
            'tax'               => 'Impuestos',
            'tracking-number'   => 'número de rastreo: :tracking_number',
        ],
    ],
];
